                ...
                <div class="main-slideshow">
                    <div class="flexslider">
                        ...
                        <?php foreach ($slider_ar as $s): ?>
                            <li>
                                <img src="<?php echo base_url(); ?>file/blog/<?php echo $s['img_header']?>" />
    ...
    <div class="container">
        <div class="row">
                ...
                <!-- <div class="row">
                    <div class="col-md-12">
                        <div class="widget-item">
                            <a href="#" class="btn btn-info btn-large"><i class="fa fa-bookmark-o"></i> STUDENT ACCESS</a>
                            <a href="#" class="btn btn-info btn-large"><i class="fa fa-bookmark-o"></i> LECTURER ACCESS</a>
                            <a href="#" class="btn btn-info btn-large"><i class="fa fa-envelope"></i> MAIL ACCESS</a>
                        </div>
                    </div> 
                </div>  -->
            ...
            <div class="col-md-4">
               ...
               <!--  <div class="widget-main">
                    <div class="widget-main-title">
                        <h4 class="widget-title"><i class="fa fa-tags"></i> SNMPTN 2015</h4>
                    </div>
                    <div class="widget-inner">
                        <img src="<?php echo base_url();?>assets/themes/home/images/snmptn.png" width="320" height="155" />
                    </div> 
                </div>  -->
